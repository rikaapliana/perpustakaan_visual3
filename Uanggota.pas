...
begin
  ...
  begin
    ...
    if (edt1.Text= zqry1.FieldList[1].AsString) and (edt2.Text = zqry1.FieldList[2].AsString) and (edt3.Text = zqry1.FieldList[4].AsString) and (edt5.Text = zqry1.FieldList[6].AsString) then
  begin
